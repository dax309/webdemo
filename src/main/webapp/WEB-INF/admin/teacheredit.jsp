					...
					<form class="form-horizontal" role="form" id="teacherAction" action="teacher" method="post">
						<c:if test="${teacher.ID != null }">
							<div class="form-group">
								 ...
								 <div class="col-sm-3">
								 	<input class="form-control" id="teacherId" name="teacherId" type="text" value="${teacher.ID }" readonly="readonly" unselectable='on' onfocus='this.blur()' />
								 </div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input class="form-control" id="teacherName" name="teacherName" type="text" value="${teacher.realname }" placeholder="教师姓名" />
							</div>
						</div>
						<div class="form-group">
							 <label for="teacherAccount" class="col-sm-2 control-label">后台登录账户</label>
							<div class="col-sm-5">
								<input class="form-control" id="teacherAccount" name="teacherAccount" type="text" value="${teacher.username }" placeholder="后台登录账户" />
							</div>
						</div>
						<div class="form-group">
							 <label for="teacherPwd" class="col-sm-2 control-label">后台登录密码</label>
							<div class="col-sm-5">
								<input class="form-control" id="teacherPwd" name="teacherPwd" type="password" value="${teacher.password }" placeholder="后台登录密码" />
							</div>
						</div>
						<br />
						<div class="form-group">
